...
while command !=4 :
    ...
    if command == 1:
        ...
        if matrix_set == 0 or answer == 'Y' or answer == 'y':
            filename = input("\nInput original network topology matrix data file[ NxN distance matrix. (value : -1 for no link, 0 for self loop) : ")  # Enter the file name example topology.txt
        ...
        if matrix_set == 1 :
            ...
            print ("\nNo network topology matrix exist. Please upload the correct data file first.. ")
print ("\nExit project.\n")